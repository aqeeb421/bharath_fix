...
class TechnicianChatDetailScreen extends StatefulWidget {
  ...
  @override
  State<TechnicianChatDetailScreen> createState() => _TechnicianChatDetailScreenState();
}

class _TechnicianChatDetailScreenState extends State<TechnicianChatDetailScreen> {
  ...
  Widget build(BuildContext context) {
    final currentUid = _auth.currentUser?.uid ?? 'technician';
          ...
          if (widget.customerPhone.isNotEmpty)
            Container(
              ...
              child: IconButton(
                ...
                onPressed: () => _makePhoneCall(widget.customerPhone),
              ),
            ),
        ],
      ),
              ...
              builder: (context, snapshot) {
                        ...
                        children: [
                          ...
                          Text(
                            _isJobDone
                                ...
                                : "Send a message to ${widget.customerName.isNotEmpty ? widget.customerName : 'customer'}",
                            style: const TextStyle(
                              fontFamily: 'Plus Jakarta Sans',
                              fontSize: 14,
                              fontWeight: FontWeight.bold,
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final isMe = (data['senderType'] == 'technician') || (data['senderId'] == currentUid);
                    final text = data['text'] ?? '';
                    final timeStr = _formatMessageTime(data['createdAt'] as Timestamp?);
                    final senderName = data['senderName'] ?? (isMe ? 'You' : widget.customerName);
