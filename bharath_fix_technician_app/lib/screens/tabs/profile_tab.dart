    ...
    showDialog(
      ...
      builder: (dialogContext) {
        return AlertDialog(
          ...
          content: const Text(
            'Are you sure you want to sign out of your BharathFix Partner Account? You will stop receiving live job requests until you sign back in.',
            style: TextStyle(
              fontFamily: 'Plus Jakarta Sans',
              fontSize: 13,
              color: Colors.grey,
